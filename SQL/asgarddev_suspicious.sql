...
LOCK TABLES `suspicious` WRITE;
/*!40000 ALTER TABLE `suspicious` DISABLE KEYS */;
INSERT INTO `suspicious` VALUES (1,100000,'Testing Suspicios Log!');
/*!40000 ALTER TABLE `suspicious` ENABLE KEYS */;
UNLOCK TABLES;
